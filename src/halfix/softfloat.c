...
#include "halfix/softfloat/softfloat-round-pack.h"
...
#include "halfix/softfloat/softfloat-macros.h"
...
| specific.
*----------------------------------------------------------------------------*/
#include "halfix/softfloat/softfloat-specialize.h"

#include "halfix/softfloat/fpu-constants.h"
